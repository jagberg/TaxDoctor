...
namespace TaxDoctor.Web.Controllers
{
    ...
    {
        [PageTitle("Accounting and Tax incl. payroll, financial statements and SARS submissions through easyFile | Accountant in Johannesburg area")]
        ...
        [PageTitle("Affordable bookkeeping, payroll and tax returns | Bookkeeper in Johannesburg area")]
        ...
        [PageTitle("Financial statements for loans and cashflow management | Accountant in Johannesburg area")]
        ...
        [PageTitle("Cheap business formation | Company registration in Johannesburg area")]
        ...
        [PageTitle("Affordable PAYE payroll service for your business | Payslips and IR5, IRP6, IT12 in Johannesburg area")]
        ...
        [PageTitle("Affordable tax services and submissions in Johannesburg area")]
        ...
        [PageTitle("Assistance with bank loan application in Johannesburg area")]
        ...
        [PageTitle("Prices for accounting, bookkeeping, payroll, tax returns and training | Accountant and Bookkeeper in Johannesburg area")]
